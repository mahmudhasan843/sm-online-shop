...
await pool.query(  INSERT INTO store_settings (
    id
  )
  VALUES (
    1
...
/* Cancelled orders cannot become
active again */
if (
...
/* =========================================================
CANCEL ORDER - PUBLIC
Customer চাইলে নিজের order ID দিয়ে cancel
========================================================= */
...
app.put(
"/api/admin/orders//payment-status",
adminAuth,
async (req, res) => {
